...
export default {
  ...
  data() {
    return {
      ...
      project: {
        ...
        investment_type: this.autoEditData.investment_type,
        email: this.autoEditData.email,
        logo: {},
      ...
      selectedCountries: this.autoEditData.countries,
      selectedCountryId: "",
      countryErrorMessage: "",
      isLoading: false,
      ...
      selectedSystems: this.autoEditData.systems,
      selectedSystemId: "",
      systemErrorMessage: "",
      isFileSelected: false,
      selectedMedias: [],
      selectedSocialMedias: this.autoEditData.social_media,
  ...
  async beforeMount() {
    ...
    if (process.client) {
      this.selectedSocialMedias = this._.clone(this.autoEditData.social_media);
    }
        ...
        case 2:
          {
            if (!this.isStepOneDataValid()) {
              ...
              this.$toastr.e(this.$tr("please_fill_all_fields_correctly"));
              return;
            } else if (!this.isStepTwoDataValid()) {
