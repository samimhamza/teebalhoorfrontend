<template>
  <v-card class="languageFilter">
    <v-card-title primary-title class="border">
      ...
      <h2>{{ $tr("filter_item", $tr("languages")) }}</h2>
      <v-spacer />
              ...
              <v-col class="ma-0 pa-0">
                <v-card class="mx-auto rounded-0">
                  <div class="scroll">
                    ...
                    <v-col cols="12 pb-0 my-0" class="">
                      <label class="subtitle-1">
                        {{ $tr("item_name", $tr("language")) }}
                      </label>
                      <v-text-field
                        :placeholder="$tr('item_name', $tr('language'))"
                        filled
                        dense
                        class="mb-0 pb-0"
                        v-model="form.name"
  ...
  created() {
    this.form = {
      ...
      updated_date: this?.prevFilterData?.updated_date
        ...
        : "",
      native: this?.prevFilterData?.native
        ? this.prevFilterData?.native
        : "",
      ids:
