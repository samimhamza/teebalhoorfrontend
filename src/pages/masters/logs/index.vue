...
export default {
  ...
  data() {
    return {
      ...
      breadcrumb_items: Logs(this).breadcrumb_items_master,
      tabItems: Logs(this).tabItems_master,
  ...
  methods: {
    ...
    //         this.selected = [];
    //         index = [];
    //         alert.removedSuccessAlert(this, this.$t("removed_title"));
    //       } else {
    //         index = [];
    //         this.$toastr.e(this.$t("could not delete some error ocured"));
    //         this.showProgressBar = false;
    //       }
    //     } catch (err) {
    //       this.showProgressBar = false;
    //     }
    //   } else {
    //     this.$toastr.e(this.$t("please select atlest one record"));
    //   }
    // },
    ...
    searchLogs(form) {
      ...
      if (form.selectedOption == 1) {
        ...
        var result;
        // this.filteredData.find(row=> row.user_id==id);
